...
void zcbor_print_compare_lines(const uint8_t *str1, const uint8_t *str2,
                               size_t size);

void zcbor_print_compare_strings(const uint8_t *str1, const uint8_t *str2,
                                 size_t size);

void zcbor_print_compare_strings_diff(const uint8_t *str1, const uint8_t *str2,
                                      size_t size);
