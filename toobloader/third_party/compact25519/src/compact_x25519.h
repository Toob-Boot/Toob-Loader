...
/*
 ...
 either means embedding a set of long-term keys in your application or setting
 up some kind of Public Key Infrastructure (PKI).
...
/*
 ...
 output:
     - private_key = resulting private key, never share this with the other
 party
     - public_key = public key to be shared with the other party
*/
/**
 * @osv
 * component: Kernel.Security
 * library: true
 * tag_status: auto
 */
