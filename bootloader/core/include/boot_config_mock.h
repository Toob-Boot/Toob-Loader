...
#ifndef CHIP_STAGE0_ABS_ADDR
#define CHIP_STAGE0_ABS_ADDR       0x00004000
#define CHIP_STAGE1A_ABS_ADDR      0x00006000
#define CHIP_STAGE1A_SIZE          0x00002000
#define CHIP_STAGE1B_ABS_ADDR      0x00008000
#define CHIP_STAGE1B_SIZE          0x00002000
#define CHIP_APP_SLOT_ABS_ADDR     0x00010000 
#define CHIP_APP_SLOT_SIZE         0x00050000
#define CHIP_STAGING_SLOT_ABS_ADDR 0x00060000
#define CHIP_STAGING_SLOT_SIZE     CHIP_APP_SLOT_SIZE
#define CHIP_RECOVERY_OS_ABS_ADDR  0x000B0000
#define CHIP_RECOVERY_OS_SIZE      0x00020000
#define CHIP_SCRATCH_SLOT_ABS_ADDR 0x00100000 /* Dedicated A/B Safe Buffer for Delta Updates */
#define CHIP_SCRATCH_SLOT_SIZE     CHIP_APP_SLOT_SIZE
#define CHIP_NETCORE_SLOT_ABS_ADDR 0x00150000 /* NetCore Base Address */
#define CHIP_NETCORE_SLOT_SIZE     0x00010000
